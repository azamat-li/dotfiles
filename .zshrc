...
export PATH=$PATH:/snap/bin:$HOME/bin:/usr/local/bin
...
plugins=(debian history git git-extras gh vue npm heroku yarn json-server vscode googler common-aliases)
